...
import { BgStars, IconAvatar, IconCursor, IconServer, IconUi, PlanetPic } from "../../utils/assets";



 const AboutSection:React.FC<{}> = () => {
  return (
    <section className="relative rounded-lg p-8 pr-0 mt-32  mx-10 bg-secondary md:p-18 border-[5px] border-secondary z-10" id="about" 
    ...
    >
      ...
      <div className="flex flex-col items-center sm:flex-row">
        ...
        <ul className="text-primary flex flex-col gap-12  sm:mt-0 p-8">
          <li className={"aboutItem flex flex-row items-center rounded-full list-none p-6 bg-gradient-to-r from-[rgba(165,215,232,0.42)] to-[rgba(255,255,255,0)] bg-[length:0_100%] bg-no-repeat transition-all duration-400 hover:bg-[length:100%_100%] sm:p-0"}>
